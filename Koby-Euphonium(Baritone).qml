...
//  I've changed Fenjuh's code to support Baritone (Euphonium) valves, and write the values that are open/close on a consistent line height.
//
...
MuseScore {
      version: "2.0"
      description: "Place Baritone (Euphonium) valves numbers for open/close under the notes.\n\u2460 = first released\n\u2461 = second released\n\u2462 = third released\n\u2776 = first pressed\n\u2777 = second pressed\n\u2778 = third pressed"
      menuPath: "Plugins.Koby-Euphonium(Baritone)"
      pluginType: "dialog"
      ...
      //                              E2                        F2                        F2#                       G2                        G2#                       A2                        A2#                       B2                        C3                        C3#                       D3                        D3#                       E3                        F3                        F3#                       G3                        G3#                       A3                        A3#                       B3                        C4                        C4#                       D4                        D4#                       E4                        F4                        F4#                       G4                        G4#                       A4                        A4#                       
